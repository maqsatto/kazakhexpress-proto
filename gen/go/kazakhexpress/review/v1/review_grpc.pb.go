...
const (
	ReviewService_HealthCheck_FullMethodName        = "/kazakhexpress.review.v1.ReviewService/HealthCheck"
	ReviewService_CreateReview_FullMethodName       = "/kazakhexpress.review.v1.ReviewService/CreateReview"
	ReviewService_GetReview_FullMethodName          = "/kazakhexpress.review.v1.ReviewService/GetReview"
	ReviewService_ListProductReviews_FullMethodName = "/kazakhexpress.review.v1.ReviewService/ListProductReviews"
	ReviewService_UpdateReview_FullMethodName       = "/kazakhexpress.review.v1.ReviewService/UpdateReview"
	ReviewService_DeleteReview_FullMethodName       = "/kazakhexpress.review.v1.ReviewService/DeleteReview"
	ReviewService_GetProductRating_FullMethodName   = "/kazakhexpress.review.v1.ReviewService/GetProductRating"
)
...
func (c *reviewServiceClient) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthCheckResponse)
	err := c.cc.Invoke(ctx, ReviewService_HealthCheck_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReviewServiceServer) HealthCheck(context.Context, *HealthCheckRequest) (*HealthCheckResponse, error) {
...
func _ReviewService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HealthCheckRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServiceServer).HealthCheck(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReviewService_HealthCheck_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServiceServer).HealthCheck(ctx, req.(*HealthCheckRequest))
	}
...
var ReviewService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ReviewService_HealthCheck_Handler,
		},
		{
	...
	Metadata: "kazakhexpress/review/v1/review.proto",
}
